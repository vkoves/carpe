...
class CategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "group member cannot add categories" do
  ...
  test "non-group members cannot add categories" do
  ...
  test "group owner can delete categories" do
    ...
    assert_difference -> { Category.count }, -1 do
      delete category_path(categories(:groupCategory)), as: :json
    end
  end
  ...
  test "group member cannot delete categories" do
    sign_in users(:memberMike)
